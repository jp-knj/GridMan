class Main {
  ...
  getBreakpoints() {
    ...
    for(let i = 0; i < this.flexBreakpointsInfo.length; i++) {
      let fromWidthID = this.flexBreakpointsInfo[i].firstInput;
      let numOfItemsID = this.flexBreakpointsInfo[i].secondInput;
